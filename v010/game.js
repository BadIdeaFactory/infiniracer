...
(() => {
  ...
  function render(dt) {
    ...
    // ─── Draw beams ──────────────────────────────────────────────
    // Two passes now (was three) — the wide × 5 / α 0.10 outer-glow pass
    // was the most expensive stroke (widest line caps to rasterize) and
    // contributed least to the visible bloom. Mid glow + crisp does the job.
    ctx.lineCap = "round";
    ctx.lineJoin = "round";
